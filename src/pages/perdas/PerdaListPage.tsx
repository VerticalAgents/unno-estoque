...
export function PerdaListPage() {
  ...
  /** Os motivos que apareceram no período, sempre na mesma ordem e cor. */
    ...
    <div className="p-4 sm:p-6 max-w-5xl mx-auto space-y-5">
      <div className="flex items-center justify-between gap-3 flex-wrap">
        ...
        <div className="flex gap-2">
          <Button variant="secondary" onClick={() => navigate('/perdas/relatorio')}>
            Relatório completo
          </Button>
      ...
      {aba === 'produto' && (
        <div className="space-y-5">
          ...
          <Card className="p-5">
            ...
            />
            <div className="mt-3 pt-3 border-t border-gray-100 dark:border-white/[.06]">
