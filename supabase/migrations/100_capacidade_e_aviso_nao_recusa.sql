-- ============================================================
-- Migration 100 — capacidade do recipiente vira aviso, nao recusa
--
-- `abrir_estoque_inicial` recusava a abertura inteira quando um recipiente
-- recebia mais do que a `capacidade_max` cadastrada. O Lucca pos 19 kg num
-- pote de acucar anotado com 17 e nao conseguiu finalizar.
--
-- Capacidade e estimativa digitada no cadastro. O peso na balanca e o fato:
-- se coube no pote, coube. Recusar obriga a mentir o peso para conseguir
-- salvar, e e o peso que vira estoque -- o sistema passaria a guardar um
-- numero que ninguem mediu, para respeitar um numero que alguem chutou.
--
-- A tela ja mostra o aviso em ambar e deixa seguir. Aqui some a recusa.
-- Continua recusando quantidade NEGATIVA, que e impossivel, nao estimativa.
--
-- Partiu de `pg_get_functiondef`, ja com a 099 dentro -- ver CLAUDE.md.
-- ============================================================
